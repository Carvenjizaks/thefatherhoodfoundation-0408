      ...
      {status === "success" && (
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[#5a3a3a] text-sm leading-relaxed">
            {email && <span className="font-medium text-[#1a0a0e]">{email}</span>}{" "}
            has been removed from our mailing list. You will no longer receive bulk emails from The Fatherhood Foundation.
          </p>
